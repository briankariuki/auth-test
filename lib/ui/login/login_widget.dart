...
import 'package:auth_test/ui/login/login_controller.dart';
...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put<LoginController>(LoginController(), tag: 'Login');
    return Scaffold(
      body: SafeArea(
        child: Column(
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        BodyMedium(
                          title: "Use your email and password to login to your account",
                          color: Palette.gray2,
                        )
                      ],
                    ),
